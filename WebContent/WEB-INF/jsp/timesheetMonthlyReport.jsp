...
<div id="page-wrapper" class="bg">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header" style="color:blue"><b> Monthly Efforts Report</b></h3>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h5><b> Monthly Efforts Report</b></h5>
					</div>

					<div class="panel-body">
						<form:form class="form-inline" method="post"
							action="${pageContext.request.contextPath}/Reports/getAllEmpTimeSheetMonthlyDetails">
							<div class="form-group">
								<label for="startDate"> Select Month </label>
								<div class="input-group">
									<input type="text" class="form-control" id="month" name="month"
										required="required" name="startdate" placeholder="Select Month" autocomplete="off">
								</div>
							</div>
