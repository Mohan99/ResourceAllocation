...
<div id="page-wrapper" class="bg">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header" style="color:blue">Mass Allocation</h3>
								...
								<div class="row">
									<div class="col-sm-12">
										...
										<div class="col-sm-offset-4 col-sm-8"
											...
											<button type="submit" class="btn btn-primary" formaction="<%=request.getContextPath()%>/Resource/updateAllMultipleResources">Allocate</button>
											...
											<button type="submit" class="btn btn-danger" formaction="<%=request.getContextPath()%>/Resource/removeAllMultipleResources/${projId}">Remove</button>
