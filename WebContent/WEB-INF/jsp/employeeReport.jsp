...
<div id="page-wrapper" class="bg">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header" style="color:blue"><b>Weekly Resource Report</b></h3>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h5><b>Weekly Resource Report</b></h5>
					</div>
										...
										<thead>
											<tr role="row" class="bg-warning">
												...
												<!-- <th class="sorting_asc" tabindex="0"
													...
													style="width: 171px;">Bench Check</th>
												<th class="sorting" tabindex="0"
													aria-controls="dataTables-example" rowspan="1" colspan="1"
													aria-label="Designation: activate to sort column ascending"
													style="width: 188px;">Bench Date</th> -->
												<!--	<th class="sorting" tabindex="0"
													aria-controls="dataTables-example" rowspan="1" colspan="1"
													aria-label="Designation: activate to sort column ascending"
													...
													<c:when test="${report.emp.employeeId != null}">
														<tr class="gradeA odd" role="row">
															...
															<%-- <td class="center">${report.emp.employeeSpecialization}</td> --%>
																	...
																	<%-- <td class="center">${report.empSkillSet}</td> --%>
																	<c:choose>
																<%-- <c:when test="${report.status!='Bench'}"> --%>
