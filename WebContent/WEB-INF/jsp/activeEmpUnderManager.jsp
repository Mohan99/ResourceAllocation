...
<script>
	function deleteEmpUnderManager(eID) {
...
<div id="page-wrapper" class="bg">
	<input type="hidden" id="deleteEmpUrl"
		value="<%=request.getContextPath()%>/Employee/deleteEmpUnderManager/" />
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header" align="center">Employee's List Under -<i><u color:"blue">${sessionScope['scopedTarget.sessionObj'].getEmpObj().getEmployeeName()}</u></i> </h3>
				<div class="col-md-6">
											...
											<c:forEach var="emp" items="${employeeList}">
												...
												<tr class="gradeA odd" role="row">
													...
													<%-- <td class="center"><a class="btn-info btn-sm"
														href="<%=request.getContextPath()%>/Employee/editEmpUnderManger/${emp.empId}">
															<i class="fa fa-edit"> </i>
													</a></td> --%>
													<%-- <td class="center"><c:choose>
															<c:when test="${emp.status=='true'}">
																<a class="btn-danger btn-sm" href="#"
																	onclick="deleteEmpUnderManager('${emp.empId}')"> <i
