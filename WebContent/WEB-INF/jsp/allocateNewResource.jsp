...
<div id="page-wrapper" class="bg">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header" style="color:blue"><b>Allocate New Resource</b></h3>
			</div>
			<div class="col-md-6">
				<br>
				<form:form class="form-horizontal" modelAttribute="resourceRequest"
					...
					<div class="form-group">
						<label for=" " class="col-sm-5 control-label">Select
							Employee<span class="asteriskField" style="color: red"> * </span></label>
						<div class="col-sm-7">
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<form:input type="text" class="form-control disabled date-picker"
								id="fromDate" path="projectFrom" required="required" autocomplete="off"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<form:input type="text" class="form-control disabled date-picker"
								id="toDate" path="projectTo" autocomplete="off"/>
						</div>
					</div>
					...
					<div class="form-group">
							...
							<div class="col-sm-7">
								<form:radiobutton path="billable" value="Y" required="required" />
								Billable
								<form:radiobutton path="billable" value="N" required="required" />
								Non-Billable
							</div>
						</div>
