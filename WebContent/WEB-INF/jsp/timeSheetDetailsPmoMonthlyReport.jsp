...
<div id="page-wrapper" class="bg">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header" style="color:blue"><b> Submitted TimeSheet Report</b></h3>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h5><b>Monthly Submitted Report</b></h5>
					</div>
									...
									<input type="hidden" value="${endDate}" name="enddate" id="enddate"> --%>
										<table align="left" width="100%"
											...
											<thead>
												<tr role="row" class="bg-warning">
													...
													<th class="sorting" tabindex="0"
														...
														aria-controls="dataTables-example" rowspan="1" colspan="1"
														aria-label="Designation: activate to sort column ascending"
														style="width: 188px;">Start Week Date</th>
														<th class="sorting" tabindex="0"
														aria-controls="dataTables-example" rowspan="1" colspan="1"
														aria-label="Designation: activate to sort column ascending"
														style="width: 188px;">End Week Date</th>
													<th class="sorting" tabindex="0"
														aria-controls="dataTables-example" rowspan="1" colspan="1"
														aria-label="Designation: activate to sort column ascending"
														style="width: 188px;">Submitted Timesheets</th>
														<th class="sorting" tabindex="0"
														aria-controls="dataTables-example" rowspan="1" colspan="1"
														aria-label="Designation: activate to sort column ascending"
														style="width: 188px;">Not Submitted Timesheets</th>
											...
											<tbody>
												...
												<c:forEach var="tsheet" items="${timeSheetDtls}">
													<tr class="gradeA odd" role="row">
														...
														<td class="sorting_1">${tsheet.empId.emailId}</td>
														 ...
														 <td class="sorting_1">${tsheet.toDate}</td>
														<td class="sorting_1">${tsheet.submittedCount}</td>
														
														<td class="sorting_1">${tsheet.balanceCount}</td>
