...
<div id="page-wrapper" class="bg">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header"  style="color:blue"><b>Inactive Employee's List</b></h3>
				<div class="col-md-6">
										...
										<thead>
											<tr role="row" class="bg-warning">
												...
												<th class="sorting" tabindex="0"
													...
													aria-controls="dataTables-example" rowspan="1" colspan="1"
													aria-label="Designation: activate to sort column ascending"
													style="width: 188px;">Exit Date</th>
												<!-- <th class="sorting" tabindex="0"
													aria-controls="dataTables-example" rowspan="1" colspan="1"
													aria-label="Browser: activate to sort column ascending"
										...
										<tbody>
											...
											<c:forEach var="emp" items="${empList}">
												...
												<tr class="gradeA odd" role="row">
													...
													<td class="center">${emp.exitDateStr}</td>
													<%-- <td class="center">${emp.joinDateStr}</td> --%>

													<td class="center">
														<button type="button" class="btn btn-success">
															<a
																href="<%=request.getContextPath()%>/Employee/updateEmployee/${emp.empId}">Activate</a>
														</button>
													</td>
