...
<div id="page-wrapper" class="bg">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header" style="color:blue"><b>Weekly Report</b></h3>
						...
						<div id="dataTables-example_wrapper"
							...
							<div class="row">
								<div class="col-sm-12">
									  ...
									  <div align="right">
										 <a href="<%=request.getContextPath()%>/Reports/exportGetAllTimeSheetWeeklyDetails/${startDate}/${endDate}" class="btn"
											...
											<thead>
												<tr role="row" class="bg-warning">
													...
													<th class="sorting" tabindex="0"
														aria-controls="dataTables-example" rowspan="1" colspan="1"
														aria-label="Designation: activate to sort column ascending"
														style="width: 220px;">Employee Logged Efforts</th>
													<th class="sorting" tabindex="0"
														aria-controls="dataTables-example" rowspan="1" colspan="1"
														aria-label="Designation: activate to sort column ascending"
