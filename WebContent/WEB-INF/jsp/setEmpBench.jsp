...
<div id="page-wrapper" class="bg">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header" style="color:blue"><b>Set As Bench</b></h3>
				<div class="col-md-6">
					<form:form class="form-horizontal" modelAttribute="EmployeeRequest"
						method="post"
						action="${pageContext.request.contextPath}/Employee/setEmpInBench">
						...
						<div class="form-group">
							<label for=" " class="col-sm-5 control-label">Bench From</label>
							<div class="col-sm-7">
								<form:input type="text"
									class="form-control disabled date-picker" id="benchDate"
									path="benchDate" />
							</div>
						</div>
